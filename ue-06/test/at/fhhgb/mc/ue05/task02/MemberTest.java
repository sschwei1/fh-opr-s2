...
public class MemberTest {
    ...
    @Test
    public void testActiveMember() throws ValueException {
        ...
        assertThrows(
            ...
            () -> new Trainer("Maximus", 100)
        );
        assertThrows(
            ValueException.class,
            () -> new TopAthlete("Maximus", -17)
        );
    }
    ...
    public void testChairMember() throws ValueException {
        ...
        // Test competence level out of range 0-10
        assertThrows(
            ValueException.class,
            () -> new ChairMember("Maximus", 100)
        );
        assertThrows(
            ValueException.class,
            () -> new ChairMember("Maximus", -17)
        );
    }
    ...
    @Test
    public void testSection() throws ValueException {
